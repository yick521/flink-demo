 ...
 */
public class CustomKafkaSink extends RichSinkFunction<IdOutput> implements CheckpointedFunction {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        String clientId = String.format("kafka-producer-%d", subtaskIndex);
